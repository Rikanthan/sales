                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      children: [
                        ...
                        CheckBoxText(header: 'Supplier Code'),
                        CheckBoxText(header: 'Brand'),
                        CheckBoxText(header: 'Supplier'),
                        CheckBoxText(header: 'Type'),
                        CheckBoxText(header: 'Tag'),
                      ],
                    ),
                    ],
                  ),
